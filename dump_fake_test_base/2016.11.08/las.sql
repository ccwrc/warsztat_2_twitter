...
--
-- Host: localhost
-- Generation Time: Nov 08, 2016 at 03:28 PM
...
(16, 15, '"Tony Halik. Tu byłem. " Skąd ten napis wziął się na mojej planecie? Predator zapyta was o to osobiście.', '2016-11-07 20:57:09'),
(17, 3, 'Sowa jest jednym z poematów o tematyce społeczno-obyczajowej zainspirowanych przez przyjazd Szewczenki na ziemie ukraińskie z P----------140', '2016-11-08 15:26:29');
...
(14, 'ccwrc', '$2y$10$uB/jiFgtGp/rBYYxC6p8JOVcth3mCJUMgL/5REzglPPi79hZPv0lC', 'ccwrc@gmail.elo'),
...
--
ALTER TABLE `tweet`
  MODIFY `tweet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
