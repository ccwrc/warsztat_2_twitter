...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['user_id']) 
    ...
    $newTweet = new Tweet();
    $newTweet->setUserId($_SESSION['user_id'])->setText($_POST['newTweet'])
            ->setCreationDate(date("Y-m-d H:i:s"))->saveToDb($conn);
...
if (isset($_SESSION['newPrivateMessage'])) {
    $infoMessageForUser = "<p class=\"warning\">Zajrzyj do <a href=\"messages.php\""
